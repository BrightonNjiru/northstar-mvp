...
const products = [
  { name: "Modern Lounge Chair", price: "KSh 8,500", image: "/images/couch.png", alt: "Modern lounge chair", description: "A comfortable statement piece designed to bring style and relaxation to your living room." },
  { name: "Premium Accent Chair", price: "KSh 12,500", image: "/images/bowl-2.png", alt: "Premium accent chair", description: "Add character and comfort to your space with a beautifully designed accent chair." },
  { name: "Ergonomic Office Chair", price: "KSh 15,000", image: "/images/bowl-3.png", alt: "Ergonomic office chair", description: "Designed to provide comfortable support while you work, study, or create." },
]
    ...
    <main>
      <section className="hero">
        <div className="shell hero-grid">
          ...
          <Image className="hero-image" src="/images/couch.png" alt="Modern Northstar furniture" width={650} height={500} priority />
        </div>
      </section>
      ...
      <section className="section story-section"><div className="shell story-grid"><div className="story-collage"><Image src="/images/couch.png" alt="Modern living room furniture" width={560} height={430} /><div className="story-stack"><Image src="/images/bowl-2.png" alt="Stylish home furniture" width={220} height={180} /><Image src="/images/bowl-3.png" alt="Contemporary furniture" width={220} height={180} /></div></div><div><h2>Furniture That Makes Your House Feel Like Home</h2><p>Your furniture should do more than fill a room. It should create comfort, express your style, and make everyday living better. At Northstar, we bring together furniture designed for real homes and modern lifestyles.</p><ul><li>Stylish designs for modern interiors</li><li>Comfortable furniture for everyday living</li><li>Quality materials built for durability</li><li>Furniture options for different budgets</li></ul><Link className="btn btn-primary" href="/shop">Shop Our Collection</Link></div></div></section>

      <section className="section tips-section"><div className="shell"><div className="section-head"><h2>Furniture Tips &amp; Ideas</h2><Link className="text-link" href="/support">View All Posts</Link></div><div className="tips">{[["How to Choose the Right Sofa", "Furniture buying guide"], ["How to Keep Your Furniture Looking New", "Furniture care tips"], ["Smart Furniture Ideas for Small Spaces", "Small space furniture ideas"]].map(([title, alt]) => <article className="tip" key={title}><Image src="/images/couch.png" alt={alt} width={360} height={220} /><h3>{title}</h3><p>By <span>Northstar</span> Furniture Guide</p></article>)}</div></div></section>
    </main>
  )
}
